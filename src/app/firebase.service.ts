...
//   url = 'https://aarshiya-5489d-default-rtdb.asia-southeast1.firebasedatabase.app/product.json';
//   url1 = 'https://aarshiya-5489d-default-rtdb.asia-southeast1.firebasedatabase.app/customers.json';
//   prod = 'https://aarshiya-5489d-default-rtdb.asia-southeast1.firebasedatabase.app/prodbal.json';
//   savewholesaler = 'https://aarshiya-5489d-default-rtdb.asia-southeast1.firebasedatabase.app/savewholesaler.json';
//   paymentofcustomer = 'https://aarshiya-5489d-default-rtdb.asia-southeast1.firebasedatabase.app/paymentofcustomer.json';
//   orderWholsalers = 'https://aarshiya-5489d-default-rtdb.asia-southeast1.firebasedatabase.app/orderWholsaler.json';
//   paymentofwholsaler = 'https://aarshiya-5489d-default-rtdb.asia-southeast1.firebasedatabase.app/wholsalerPayment.json';
//   constructor(private http: HttpClient) { }
//   // product
//   saveproduct(show: any[]) {
//     return this.http.put(this.url, show)
//   }
//   showroduct() {
...
//     return this.http.put(this.url1, customers)
//   }
//   showcustomer() {
//     return this.http.get(this.url1)
//   }
//   // product balance
//   saveprodbalance(add: any[]) {
//     return this.http.put(this.prod, add)
//   }
//   showprodbalance() {
//     return this.http.get(this.prod)
//   }
//  //wholsaler name
//   savewholesalers(savewholsaler: any[]) {
//     return this.http.put(this.savewholesaler, savewholsaler)
//   }
//   showWholsaler() {
//     return this.http.get(this.savewholesaler)
//   }
//   //custmer payment
//   PaymentOfCustomer(customerPayment: any) {
//     return this.http.put(this.paymentofcustomer, customerPayment)
//   }
//   showPaymentOfCustomer(){
//     return this.http.get(this.paymentofcustomer)
//   }
//   //wholesaler order

//   wholsalerorder(orderWholsaler: any) {
//     return this.http.put(this.orderWholsalers, orderWholsaler)

//   }
//   showwholsalerorder() {
//     return this.http.get(this.orderWholsalers)

//   }
//     //wholesaler payment

//   savePaymentOfWholesaler(paymentofwholsaler: any) {
//     return this.http.put(this.paymentofwholsaler, paymentofwholsaler)
//   }
//   showPaymentOfWholesaler(){
//     return this.http.get(this.paymentofwholsaler)
//   }
// }
import { Injectable } from '@angular/core';
